...
export function extract_uuid_name() {
    const set = new Set();
    const resultats = [];
...
export function getDataApp(name) {
...
export function getApplicationsByFamily(appList) {
    const result = {
        Applications: [],
        Backend: [],
        Outils: []
...
export function getApplicationsByClient(clientIdentifier) {
    const result = [];
